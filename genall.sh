...
./genreel.py --method=random 12 60 25 | tee >(head -n 1 > in/s_r25.txt)   | tail -n 25  > in/r25.in
./genreel.py --method=random 12 60 30 | tee >(head -n 1 > in/s_r30.txt)   | tail -n 30  > in/r30.in
./genreel.py --method=random 12 60 40 | tee >(head -n 1 > in/s_r40.txt)   | tail -n 40  > in/r40.in
./genreel.py --method=random 12 60 50 | tee >(head -n 1 > in/s_r50.txt)   | tail -n 50  > in/r50.in
...
./genreel.py --method=min_overlap 12 60 25 | tee >(head -n 1 > in/s_p25.txt)   | tail -n 25  > in/p25.in
./genreel.py --method=min_overlap 12 60 30 | tee >(head -n 1 > in/s_p30.txt)   | tail -n 30  > in/p30.in
./genreel.py --method=min_overlap 12 60 40 | tee >(head -n 1 > in/s_p40.txt)   | tail -n 40  > in/p40.in
./genreel.py --method=min_overlap 12 60 50 | tee >(head -n 1 > in/s_p50.txt)   | tail -n 50  > in/p50.in
...
./genreel.py --method=max_overlap 12 60 25 | tee >(head -n 1 > in/s_q25.txt)   | tail -n 25  > in/q25.in
./genreel.py --method=max_overlap 12 60 30 | tee >(head -n 1 > in/s_q30.txt)   | tail -n 30  > in/q30.in
./genreel.py --method=max_overlap 12 60 40 | tee >(head -n 1 > in/s_q40.txt)   | tail -n 40  > in/q40.in
./genreel.py --method=max_overlap 12 60 50 | tee >(head -n 1 > in/s_q50.txt)   | tail -n 50  > in/q50.in
